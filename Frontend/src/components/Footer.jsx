                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="text-sm">
                            <li><Link to="/" className="hover:text-white" onClick={scrollToTop}>Home</Link></li>
                            <li><Link to="/products" className="hover:text-white" onClick={scrollToTop}>Products</Link></li>
                            <li><Link to="/about" className="hover:text-white" onClick={scrollToTop}>About</Link></li>

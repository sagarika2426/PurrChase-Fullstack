    ...
    <div className="justify-between m-auto border border-gray-200 rounded-lg lg:p-10">
      ...
      {favoriteProducts.length === 0 ? (
        <div className="flex flex-col m-auto lg:w-1/2 text-center justify-center">
            ...
            className="my-4"/>
             <Link to={"/products"}>
            <p className="bg-red-700 py-2 px-2 w-1/2 rounded-md m-auto text-white font-semibold mb-4">Explore Products</p>
            </Link>
         ...
         <div className="flex flex-col justify-between ml-4 w-full">
           ...
           <div className="flex items-center justify-between">
             ...
             <div className="flex items-center">
               <IconButton onClick={() => removeFromFavorites(product._id)}>
                 <DeleteIcon />
               </IconButton>
             </div>
           </div>
